...
fun getJuzList(): List<JuzMetadata> {
    return listOf(
        ...
        JuzMetadata(20, "Aman Khalaqa", "أَمَّنْ خَلَقَ", 382, 27, 60),
        JuzMetadata(21, "Utlu Ma Oohiya", "اتْلُ مَا أُوحِيَ", 401, 29, 45),
        JuzMetadata(22, "Wa Man Yaqnut", "وَمَنْ يَقْنُتْ", 422, 33, 31),
        JuzMetadata(23, "Wa Maliya", "وَمَالِيَ", 441, 36, 22),
