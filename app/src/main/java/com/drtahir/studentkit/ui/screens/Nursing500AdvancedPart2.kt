...
object Nursing500AdvancedPart2 {
    ...
    fun getPharmAndFundamentalsAdvancedQuestions(startId: Int): List<NursingExamQuestion> {
        ...
        val pharmTopics = listOf(
            ...
            Triple("Pharmacology: Lithium Carbonate Toxicity & Serum Level Monitoring", "Therapeutic range 0.6–1.2 mEq/L; toxicity (> 1.5 mEq/L) presents with coarse hand tremors, ataxia, confusion, and persistent diarrhea; maintain normal sodium and fluid intake", "Lithium toxicity is prevented by restricting sodium and restricting fluids to 200 mL/day"),
