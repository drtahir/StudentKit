...
object Nursing500BankPart2 {
    ...
    fun getPharmAndFundamentalsQuestions(startId: Int): List<NursingExamQuestion> {
        ...
        val pharmScenarios = listOf(
            ...
            Triple("Vancomycin Red Man Syndrome vs Anaphylaxis", "Red Man Syndrome is a histamine release caused by rapid infusion (flushing, rash on upper body); slow infusion rate to over 60-120 minutes", "Stop vancomycin permanently and treat Red Man Syndrome as anaphylaxis"),
            ...
            Triple("Metformin (Glucophage) Lactic Acidosis & Contrast Dye", "Withhold metformin 48 hours BEFORE and AFTER IV iodinated contrast dye procedures to prevent acute renal failure", "Give double dose metformin right before CT scan with contrast"),
