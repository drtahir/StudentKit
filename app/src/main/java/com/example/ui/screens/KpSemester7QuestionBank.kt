...
object KpSemester7QuestionBank {
    ...
    fun getQuestions(startId: Int): List<KpSemesterQuestion> {
        ...
        val res = listOf(
            ...
            Triple("Independent Samples t-test is used to compare the means of:", listOf("Three or more groups", "TWO independent / separate groups on a continuous variable (e.g. Exam scores of Male vs Female nurses)", "Pre and post test in same group", "Categorical proportions"), 1),
            Triple("Paired Samples t-test (Dependent t-test) is used to compare means of:", listOf("Two different hospitals", "ONE group measured at TWO time points (e.g. Knowledge score Pre-test vs Post-test in same nurses)", "Four independent categories", "Ranks"), 1),
            ...
            Triple("Pilot Study in research methodology is defined as a:", listOf("Full-scale 10,000 participant study", "Small-scale preliminary trial study conducted to test feasibility, instruments, and recruitment before full study", "Final report", "Literature review"), 1),
