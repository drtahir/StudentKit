...
object Nursing500AdvancedPart1 {
    ...
    fun getMedSurgAdvancedQuestions(startId: Int): List<NursingExamQuestion> {
        ...
        val medSurgTopics = listOf(
            ...
            Triple("Musculoskeletal: Osteoarthritis vs Rheumatoid Arthritis", "OA: asymmetric degenerative joint disease, worse with activity, Heberden/Bouchard nodes; RA: symmetric autoimmune systemic inflammation, morning stiffness > 1 hour", "RA is non-inflammatory wear-and-tear in elderly hips"),
