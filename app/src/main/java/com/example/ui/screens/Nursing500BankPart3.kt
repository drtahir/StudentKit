...
object Nursing500BankPart3 {
    ...
    fun getPediatricObstetricPsychQuestions(startId: Int): List<NursingExamQuestion> {
        ...
        val pedsScenarios = listOf(
            ...
            Triple("Pediatric Dehydration Severity Signs", "Sunken fontanelle, absence of tears when crying, dry mucous membranes, delayed capillary refill (>3 sec), oliguria (<1 mL/kg/hr)", "Bulging fontanelle with profuse tearing"),
        ...
        val obScenarios = listOf(
            ...
            Triple("Methylergonovine (Methergine) Contraindication", "CONTRAINDICATED in clients with Hypertension or Preeclampsia (causes severe vasoconstriction/stroke)", "Administer methergine to preeclamptic mother with BP 170/110"),
        ...
        val psychScenarios = listOf(
            ...
            Triple("Neuroleptic Malignant Syndrome (NMS) vs Serotonin Syndrome", "NMS: High fever, 'lead pipe' muscle rigidity, elevated CK, caused by antipsychotics; treat with Dantrolene/Bromocriptine", "NMS is caused by SSRIs with hyperreflexia"),
            ...
            Triple("Borderline Personality Disorder Splitting Behavior", "Splitting (viewing staff as 'all good' or 'all bad'); maintain consistent boundaries, hold team conferences to ensure uniform approach", "Allow patient to negotiate separate rules with favorite nurse"),
