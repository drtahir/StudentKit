...
object Nursing500ElitePart1 {
    ...
    fun getMedSurgEliteQuestions(startId: Int): List<NursingExamQuestion> {
        ...
        val medSurgEliteTopics = listOf(
            ...
            Triple("Cardiovascular: Peripheral Venous Insufficiency vs PAD Elevation", "Venous insufficiency: elevate legs above heart level to enhance venous return and reduce stasis edema; PAD: dangle legs in dependent position to promote arterial gravity flow", "Elevate legs above heart level in acute severe peripheral arterial occlusion"),
            Triple("Respiratory: Cystic Fibrosis Sweat Chloride Test & Pancreatic Enzymes", "Diagnosed by elevated sweat chloride (> 60 mEq/L); administer pancreatic enzymes with ALL meals and snacks to enable fat and protein absorption", "Give pancreatic enzymes 5 hours after meals with hot acidic grapefruit juice"),
            ...
            Triple("Renal: Chronic Kidney Disease Hyperkalemia Emergency", "Potassium > 6.5 mEq/L risk of fatal dysrhythmias; administer IV Calcium Gluconate for myocardial membrane stabilization, followed by IV insulin with dextrose", "Give oral potassium chloride supplements immediately for hyperkalemia"),
